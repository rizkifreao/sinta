...
INSERT IGNORE INTO `detail_pesanan` (`id`, `pemesanan_id`, `no_kontainer`, `no_seal`, `biaya_tambahan`, `total`) VALUES
...
INSERT IGNORE INTO `konsumen` (`id_konsumen`, `nama_konsumen`, `jabatan`, `perusahaan`, `npwp`, `alamat`, `profil_perusahaan`, `dok_MOU`, `is_delete`) VALUES
...
-- Dumping data for table sinta.notifikasi: ~13 rows (approximately)
/*!40000 ALTER TABLE `notifikasi` DISABLE KEYS */;
INSERT IGNORE INTO `notifikasi` (`id_notif`, `pengirim`, `penerima`, `keterangan`, `data`, `status_notif`) VALUES
...
INSERT IGNORE INTO `pemesanan` (`id_pesanan`, `id_konsumen`, `konsumen`, `nama_barang`, `kapasitas_muat`, `tujuan`, `jum_kontainer`, `tipe`, `_20`, `_40`, `tarif`, `total_tarif`, `tgl_pesan`, `jadwal_kirim`, `keterangan`, `status_pengiriman`, `is_tagihan`, `send_by`) VALUES
...
INSERT IGNORE INTO `rute` (`id_rute`, `id_konsumen`, `tujuan`, `_20`, `_40`, `is_deleted`) VALUES
...
INSERT IGNORE INTO `sistem_setting` (`id`, `nama_perusahaan`, `alamat`, `telp`, `email`, `bank`, `cabang_bank`, `no_rekening`, `atas_nama`, `npwp`, `direktur`, `logo`) VALUES
...
INSERT IGNORE INTO `tb_groups` (`id`, `name`, `description`) VALUES
	(1, 'Admin', 'Roles Admin'),
...
INSERT IGNORE INTO `tb_users` (`id`, `ip_address`, `id_konsumen`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `avatar`) VALUES
...
INSERT IGNORE INTO `tb_users_groups` (`id`, `user_id`, `group_id`) VALUES
	(38, 1, 1),
	(111, 9, 2),
	(121, 19, 2),
	(124, 20, 1),

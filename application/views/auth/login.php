...
<style>
        ...
        .bg-img{
            background-image: url("<?= base_url('assets')?>/img/Kontainer.jpg"); 
...
<body>
    <div class="main-wrapper bg-img">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-color">
            <div class="auth-box bg-color border-top border-secondary">
                <div id="loginform">
